...
export class CreateTable1681653710251 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`homes\` (\`idHome\` int NOT NULL AUTO_INCREMENT, \`title\` varchar(255) NOT NULL, \`price\` int NOT NULL, \`address\` varchar(255) NOT NULL, \`bathrooms\` int NOT NULL, \`bedrooms\` int NOT NULL, \`description\` longtext NULL, \`rate_stars\` int NULL, \`status\` tinyint NOT NULL DEFAULT 1, \`idUser\` int NULL, \`idCategory\` int NULL, PRIMARY KEY (\`idHome\`)) ENGINE=InnoDB`);
