...
export class FixCouponEntity1683220815555 implements MigrationInterface {
    name = 'FixCouponEntity1683220815555'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`coupons\` ADD \`createAt\` datetime NULL DEFAULT CURRENT_TIMESTAMP`);
    }
