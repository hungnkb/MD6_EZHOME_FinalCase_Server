...
export class FixCouponCascade1683192218495 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`homes\` ADD UNIQUE INDEX \`IDX_d6aa0c0f753cae051551923427\` (\`idCoupon\`)`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_d6aa0c0f753cae051551923427\` ON \`homes\` (\`idCoupon\`)`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX \`REL_d6aa0c0f753cae051551923427\` ON \`homes\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`homes\` DROP INDEX \`IDX_d6aa0c0f753cae051551923427\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`homes\` ADD CONSTRAINT \`FK_d6aa0c0f753cae0515519234275\` FOREIGN KEY (\`idCoupon\`) REFERENCES \`coupons\`(\`idCoupon\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
